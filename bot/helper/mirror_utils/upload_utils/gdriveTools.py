...
class GoogleDriveHelper:
    ...
    def __upload_empty_file(self, path, file_name, mime_type, parent_id=None):
        ...
        file_metadata = {
            'name': file_name,
            'description': 'Uploaded using RIDLEY Mirror Bot',
            'mimeType': mime_type,
        }
    ...
    def upload_file(self, file_path, file_name, mime_type, parent_id):
        ...
        file_metadata = {
            'name': file_name,
<<<<<<< HEAD
            'description': 'Uploaded by RIDLEY Mirror Bot',
=======
            'description': 'Uploaded by ridley Mirror Bot',
>>>>>>> a9f5c2924c24a527500b417ae1ad68c9c55c6d24
            'mimeType': mime_type,
        }
        if parent_id is not None:
            file_metadata['parents'] = [parent_id]
    ...
    def edit_telegraph(self):
        ...
        for content in self.telegraph_content :
            ...
            Telegraph(access_token=TELEGRAPH_TOKEN).edit_page(path = self.path[prev_page],
                                 title = 'RIDLEY Mirror Bot - Search',
                                 author_name='RIDLEY Mirror Bot',
                                 author_url='https://github.com/Prashant-blip-cell/RIDLEY',
